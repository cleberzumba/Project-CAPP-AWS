...
This project uses data from the Open-Meteo https://open-meteo.com/ API using the configured URL to collect weather information. The API returns daily maximum and minimum temperatures for a specific location over a defined period.
